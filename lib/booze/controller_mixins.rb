...
<a href="#" onclick="$('#debug_bar').css({'width': '90%', 'z-index': '40000'}); $('#debug_bar ol').show(); return false;" style="color: #{config.text_color};"><span style="display: block; font-size: 18px; font-weight: bold;">#{queries.size}</span> queries</a>
EOL
